      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center">
          ...
          <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
            Manage elections efficiently and securely. Monitor voting progress, handle voter
            registration, and maintain election integrity.
          </p>
        </div>
        ...
        <div className="mt-20 bg-emerald-50 rounded-xl p-8">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-gray-900">View Votes</h2>
            <p className="mt-4 text-lg text-gray-600">View all the casted votes.</p>
            <button
